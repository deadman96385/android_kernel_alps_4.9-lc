...
typedef struct DDP_MODULE_DRIVER {
	...
	int (*build_cmdq)(enum DISP_MODULE_ENUM module, void *cmdq_handle, CMDQ_STATE state);
	...
	int (*enable_irq)(enum DISP_MODULE_ENUM module, void *handle, DDP_IRQ_LEVEL irq_level);
} DDP_MODULE_DRIVER;
